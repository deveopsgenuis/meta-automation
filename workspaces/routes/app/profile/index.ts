...
/**
* @see \App\Http\Controllers\App\Settings\ProfileController::language
* @see app/Http/Controllers/App/Settings/ProfileController.php:75
* @route '/settings/language'
*/
export const language = (options?: RouteQueryOptions): RouteDefinition<'put'> => ({
...
* @route '/settings/language'
*/
language.put = (options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: language.url(options),
    method: 'put',
})
...
const profile = {
    ...
    deletePhoto: Object.assign(deletePhoto, deletePhoto),

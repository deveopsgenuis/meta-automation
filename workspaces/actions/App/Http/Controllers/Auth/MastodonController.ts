...
/**
* @see \App\Http\Controllers\Auth\MastodonController::authorizeInstance
* @see app/Http/Controllers/Auth/MastodonController.php:42
* @route '/connect/mastodon'
*/
export const authorizeInstance = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: authorizeInstance.url(options),
    method: 'post',
})

authorizeInstance.definition = {
    methods: ["post"],
    url: '/connect/mastodon',
...
* @route '/connect/mastodon'
*/
authorizeInstance.url = (options?: RouteQueryOptions) => {
    return authorizeInstance.definition.url + queryParams(options)
}
...
* @route '/connect/mastodon'
*/
authorizeInstance.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: authorizeInstance.url(options),
    method: 'post',
})
...
const MastodonController = { connect, authorizeInstance, callback }

export default MastodonController
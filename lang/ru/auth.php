...
return [
    ...
    */
    ...
    'legal' => 'Продолжая, вы соглашаетесь с нашими <a href="/terms" target="_blank">Условиями использования</a> и <a href="/privacy" target="_blank">Политикой конфиденциальности</a>.',
